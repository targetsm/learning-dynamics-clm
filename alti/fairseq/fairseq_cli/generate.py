...
def _main(args, output_file):
    ...
    # open file for storing of probabilities
    probs_path = os.path.join(args.results_path, "probs-{}.npy".format(args.gen_subset))
    probs_file = open(probs_path, 'wb')
    ...
    for sample in progress:
        ...
        for i, sample_id in enumerate(sample["id"].tolist()):
            ...
            for j, hypo in enumerate(hypos[i][: args.nbest]):
                ...
                # save probability scores for each model
                if 'probs' in hypo:
                    np.save(probs_file, hypo['probs'])
