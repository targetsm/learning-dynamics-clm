...
vocab_en = open('/local/home/ggabriel/ma/models/tm/data-bin/iwslt14.sep.tokenized.de-en/dict.en.txt', 'r').readlines()
...
print(vocab_idx)
c = 0
with open('/local/home/ggabriel/ma/data/sentp/iwslt14.sep.tokenized.de-en/train.en', 'r') as f_en:
    for line in f_en:
