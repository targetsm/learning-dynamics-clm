...
ORIG=/local/home/ggabriel/ma/data/tl/wmt22deen/wmt22.sep.tokenized.de-en
TEXT=./data/wmt22.sep.tokenized.de-en
...
fairseq-preprocess --source-lang de --target-lang en \
    ...
    --destdir data-bin/wmt22.sep.tokenized.de-en \
    --workers 8
#exit 0
CUDA_VISIBLE_DEVICES=5 fairseq-train \
    data-bin/wmt22.sep.tokenized.de-en \
