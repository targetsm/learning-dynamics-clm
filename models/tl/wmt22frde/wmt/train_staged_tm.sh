...
TEXT=$HOME/ma/data/tl/wmt22frde/full/wmt22.sep.tokenized.fr-de
#TEXT=$HOME/ma/data/sentp/iwslt14.sep.tokenized.de-en
#TEXT=/local/home/ggabriel/ma/data/tl/wmt22frde_subset/tm/wmt22.sep.tokenized.fr-de
CUDA=7
...
CUDA_VISIBLE_DEVICES=$CUDA fairseq-train \
